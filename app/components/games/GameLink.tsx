...
const GameLink = ({ data }: Props) => {
  return (
    <Link
      ...
      className="relative flex h-52 w-full max-w-96 flex-col justify-end gap-3 overflow-hidden rounded-xl bg-gradient-to-t from-black/90 via-black/50 to-transparent p-4 transition hover:scale-95 hover:via-black/70 sm:px-6 md:px-4 lg:gap-4"
    >
