...
const GameLink = ({ data }: Props) => {
  return (
    <Link
      ...
      className="relative flex h-52 w-full max-w-96 flex-col justify-end gap-3 overflow-hidden rounded-xl p-4 transition hover:scale-95  sm:px-6 md:px-4 lg:gap-4"
    >
      <Hero src="/assets/hero.jpg" width={300} height={50} alt={data.title} />
