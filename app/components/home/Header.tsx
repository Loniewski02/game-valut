    ...
    <header className="py-6 lg:py-8">
      <Wrapper className="section-inner-x relative h-full content-center overflow-hidden rounded-2xl bg-[url('/assets/demoIMG.png')] bg-cover bg-no-repeat pb-14 pt-36">
        ...
        <div className="relative z-30 flex flex-col gap-4">
          <h1 className="max-w-60 text-4xl font-semibold tracking-wide text-White md:mb-4 md:text-[40px] md:leading-[1.3] lg:max-w-max lg:text-5xl">
            Your video game hub!
          </h1>
          ...
          <div className="mt-10 flex flex-col gap-4 md:flex-row">
            <LinkBtn href="/auth?mode=register">Get started</LinkBtn>
            <LinkBtn href="/games" transparent>
              Browse Games
            </LinkBtn>
          </div>
        </div>
